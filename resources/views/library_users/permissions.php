        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="permission-heading">
                    <h4>Add User Permission</h4>

                    <div class="accept-all">
                        <input type="checkbox" class="me-2" id="all">
                        <label for="all">Add All</label>
                    </div>
                </div>
                <ul class="userPermissionList">
                    <li>
                        <div class="d-flex">
                            <input type="checkbox" class="me-2" id="one">
                            <label for="one">Permission Name</label>
                        </div>
                    </li>
                    <li>
                        <div class="d-flex">
