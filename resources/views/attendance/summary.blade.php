...
<style>
    .att-page { max-width: 900px; margin: 0 auto; }
    .att-header { display: flex; align-items: center; gap: 12px; margin-bottom: 18px; }
    .att-header h4 { margin: 0; color: #07156f; font-weight: 800; }
    ...
    .att-calendar-nav .btn-nav { width: 38px; height: 38px; border-radius: 50%; background: #07156f; color: #fff; display: grid; place-items: center; border: 0; text-decoration: none; }
    .att-calendar-nav .btn-nav.disabled { background: #ccd1e0; pointer-events: none; }
    .att-calendar-nav h5 { margin: 0; color: #07156f; font-weight: 800; }
    .att-weekdays { display: grid; grid-template-columns: repeat(7, 1fr); gap: 6px; text-align: center; color: #777; font-weight: 700; font-size: .82rem; margin-bottom: 6px; }
    .att-grid { display: grid; grid-template-columns: repeat(7, 1fr); gap: 6px; }
    .att-cell { border-radius: 8px; padding: 8px 4px; text-align: center; min-height: 56px; }
    .att-cell .day-num { font-weight: 700; font-size: .95rem; }
    .att-cell .day-hours { display: block; font-size: .72rem; margin-top: 2px; }
    ...
    .att-legend { display: flex; gap: 18px; margin-top: 14px; padding-top: 12px; border-top: 1px solid #edf0f4; font-size: .84rem; color: #555; flex-wrap: wrap; }
    .att-legend span { display: inline-flex; align-items: center; gap: 6px; }
    .att-legend .dot { width: 10px; height: 10px; border-radius: 50%; display: inline-block; }
    .dot-full { background: #2e9c2e; }
    .dot-half { background: #e8a300; }
    .dot-absent { background: #d60000; }
    .att-stats { display: grid; grid-template-columns: repeat(4, 1fr); gap: 10px; margin-bottom: 20px; }
    .att-stat { border-radius: 10px; padding: 14px 10px; text-align: center; }
    .att-stat strong { display: block; font-size: 1.5rem; }
    .att-stat span { font-size: .82rem; color: #555; }
    ...
    .att-logs-header { display: flex; align-items: baseline; justify-content: space-between; margin-bottom: 4px; }
    ...
    .att-log-row { border: 1px solid #e4e7ed; border-radius: 8px; background: #fff; padding: 12px 14px; display: grid; grid-template-columns: 52px minmax(0, 1fr) auto 22px; gap: 12px; align-items: center; margin-bottom: 10px; text-decoration: none; color: inherit; }
    ...
    .att-log-hours { text-align: right; color: #07156f; font-weight: 700; }
    @media (max-width: 600px) {
        .att-cell { min-height: 44px; padding: 6px 2px; }
...
<div class="att-page">
    <div class="att-header">
        ...
        <h4>Attendance of {{ $learnerName }}</h4>
    </div>
