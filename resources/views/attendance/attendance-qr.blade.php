...
let scanner = null;
let scanDone = false;
const audioSuccess = new Audio('public/audio/success.mp3');
const audioExpired = new Audio('public/audio/expired.mp3');
const audioError   = new Audio('public/audio/error.mp3');
