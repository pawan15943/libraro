     ...
     <div class="print-container">
        <div class="card front">
            ...
            <div class="plaanInfo">
                ...
                <div class="barcode pe-1">{!! QrCode::size(100)->generate(generateLearnerQrPayload($branch->library_id ?? $learner_detail->branch_id, $learner_detail->learner->learner_no)) !!}</div>
            </div>
