...
<form method="POST" action="{{ route('master.configuration.store') }}" id="configure">
    @csrf

<h5 class="mb-3">Plan Types & Prices</h5>

<div id="planTypeWrapper">
    <div class="row" id="planRowContainer">

        <!-- SHIFT 1 -->
        <div class="col-lg-6 plan-row-wrapper">
            <div class="plan-row border bg-white rounded p-3 mb-3">
                ...
                <div class="row g-3 align-items-end mt-2">
                    ...
                    <div class="col-lg-12 d-flex gap-2">
                        <button type="button" class="btn btn-primary btn-sm add-plan-row">
                            Add More
                        </button>
                        <button type="button" class="btn btn-danger btn-sm remove-plan-row d-none">
                            Remove
                        </button>
                    </div>
