        ...
        <div style="padding: 20px; color: #333333;">
            ...
            <div style="text-align: center; margin-bottom: 30px;">
                <h2
                    ...
                    Hello {{ $booking->branch->display_name ?? 'Owner' }},</h2>
                <p style="font-size: 16px; line-height: 1.8; font-family: 'Mulish', sans-serif;">New Registration Payment Request</p>
            ...
            <div style="text-align: center; margin-bottom: 30px;">
                <h2
                    style="font-size: 26px; font-weight: 600; font-family: 'Outfit', sans-serif; color: #000; margin-bottom: 15px;">
                    A new registration with a payment request has been submitted.</h2>
                <p style="font-size: 16px; line-height: 1.8; font-family: 'Mulish', sans-serif;">Join hundreds of
                    Booking ID:{{ $booking->id }}</p>
                <a href="{{route('register')}}"
                    style="display: inline-block; margin: 20px 0; padding: 12px 30px; background-color: #000; color: #ffffff; font-size: 16px; text-decoration: none; border-radius: 5px; font-family: 'Mulish', sans-serif;">
                    Customer Name:{{ $booking->name }}</a>
            </div>
        </div>
