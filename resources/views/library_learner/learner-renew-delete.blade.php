...
@can('has-permission', 'Search Learner')
    <div class="row mt-4 mb-3 find-a-learner renew-delete-page">
    ...
    @if(isset($learners) && $learners->total() > 0)
        <div class="row renew-delete-results text-start">
            <div class="col-12">
                        ...
                        <tbody>
                            @foreach($learners as $bundle)
                                ...
                                <tr>
                                    ...
                                    <td class="small text-start align-top" style="text-align: left !important;">
                                        @if($renewTx)
                                            Paid {{ $money($renewTx->paid_amount) }}     <br>
                                    ...
                                    <td class="small text-start align-top" style="text-align: left !important;">
                                        @if($canDel && $renewTx)
                                            <form method="POST" action="{{ route('create.renew.delete.destroy', ['transaction' => $renewTx->id]) }}" class="d-inline renew-delete-confirm-form"
                                                data-swal-title="Delete this renew?"
                                                data-swal-text="The previous booking will be restored. This cannot be undo from here.">
                                                @csrf
